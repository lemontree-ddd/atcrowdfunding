                ...
                <div class="panel-body">
                    ...
                    <form action="admin/update.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword">登陆账号</label>
                            <input name="loginAcct" value="${requestScope.admin.loginAcct}" type="text" class="form-control" id="exampleInputPassword" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
