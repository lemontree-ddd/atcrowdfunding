                ...
                <div class="panel-body">
                    <form action="assign/do/role/assign.html" method="post"  role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <select id="exampleInputPassword"
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            ...
                            <select id="exampleInputPassword1"
                                    name="roleIdList"
                                    class="form-control" multiple="multiple" size="10" style="width:100px;overflow-y:auto;">
                        ...
                        <button  id="submitBtn" style="width: 150px;margin: 50px auto 0px auto" type="submit" class="btn btn-lg btn-success btn-block">保存</button>
